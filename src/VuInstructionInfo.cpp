...
#define VU_ACC_BC_ACC_READ(mn, name, args, pattern) \
	...
	const VuInstructionInfo kInstructions[] =
	{
		...
		VU_INFO(VU_OP_LQ, "LQ", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):zero|imm(vi):evaluate", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 5, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_NONE, 0, VU_BYPASS_LOAD_TO_FTOI),
		VU_INFO(VU_OP_LQD, "LQD", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):predec", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 5, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_PREDEC, 0, VU_BYPASS_LOAD_TO_FTOI),
		VU_INFO(VU_OP_LQI, "LQI", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):postinc", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 5, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_POSTINC, 0, VU_BYPASS_LOAD_TO_FTOI),
