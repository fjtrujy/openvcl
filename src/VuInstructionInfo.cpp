...
#define VU_ACC_READS(mn, name, args, pattern, reads) \
	...
	const VuInstructionInfo kInstructions[] =
	{
		...
		VU_INFO("lq", "LQ", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):zero|imm(vi):evaluate", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 4, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_NONE, 0, VU_BYPASS_NONE),
		VU_INFO("lqd", "LQD", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):predec", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 4, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_PREDEC, 0, VU_BYPASS_NONE),
		VU_INFO("lqi", "LQI", 2, Operand::LOWER|Operand::DEST, "vf:dest:write,(vi):postinc", Operand::LSU, VU_PIPE_LOWER, VU_EXEC_LSU, 1, 4, VU_INSTR_NONE, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_LOAD, VU_MEMORY_FLAG_POSTINC, 0, VU_BYPASS_NONE),
		...
		VU_INFO("b", "B", 1, Operand::LOWER, "imm:branch", Operand::BRU, VU_PIPE_LOWER, VU_EXEC_BRU, 2, 2, VU_INSTR_BRANCH, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_NONE, VU_MEMORY_FLAG_NONE, 1, VU_BYPASS_NONE),
		VU_INFO("bal", "BAL", 2, Operand::LOWER, "vi:write:address,imm:branch", Operand::BRU, VU_PIPE_LOWER, VU_EXEC_BRU, 2, 2, VU_INSTR_BRANCH, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_NONE, VU_MEMORY_FLAG_NONE, 1, VU_BYPASS_NONE),
		VU_INFO("jr", "JR", 1, Operand::LOWER, "vi:branch", Operand::BRU, VU_PIPE_LOWER, VU_EXEC_BRU, 2, 2, VU_INSTR_BRANCH, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_NONE, VU_MEMORY_FLAG_NONE, 1, VU_BYPASS_NONE),
		VU_INFO("jalr", "JALR", 2, Operand::LOWER, "vi:write:address,vi:branch", Operand::BRU, VU_PIPE_LOWER, VU_EXEC_BRU, 2, 2, VU_INSTR_BRANCH, VU_RESOURCE_NONE, VU_RESOURCE_NONE, VU_MEMORY_NONE, VU_MEMORY_FLAG_NONE, 1, VU_BYPASS_NONE),
