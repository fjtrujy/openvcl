...
extern u32 vu1TriangleStrip_CodeStart __attribute__((section(".vudata")));
extern u32 vu1TriangleStrip_CodeEnd __attribute__((section(".vudata")));
...
void init()
{
  pdkVu1UploadProg(0,&vu1TriangleStrip_CodeStart,&vu1TriangleStrip_CodeEnd);
}
...
void update(pdkMatrix* matrix)
{
  ...
  pdkVu1ListAdd128(GS_GIFTAG(1, 1, 1, GS_PRIM( GS_PRIM_TRISTRIP, GS_PRIM_SFLAT, GS_PRIM_TOFF, 
  ...
  // adress 6-10 (vertex coords, 4 vertices for triangle strip)
