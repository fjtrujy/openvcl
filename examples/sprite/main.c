...
extern u32 vu1Sprite_CodeStart __attribute__((section(".vudata")));
extern u32 vu1Sprite_CodeEnd __attribute__((section(".vudata")));
...
int main()
{
  ...
  while(1)
  {
    ...
    pdkMatrixRotateX(&rotateMatrix, angle );
...
void init()
{
  pdkVu1UploadProg(0,&vu1Sprite_CodeStart,&vu1Sprite_CodeEnd);
}
...
void update(pdkMatrix* matrix)
{
  ...
  pdkVu1ListAdd128(GS_GIFTAG(1, 1, 1, GS_PRIM( GS_PRIM_SPRITE, GS_PRIM_SFLAT, GS_PRIM_TOFF, 
  ...
  // adress 6-8 (vertex coords, 2 vertices for sprite)
