...
pt_light_vert_loop_lid:
 ...
 mul.xyz temp94, atten, atten_coeff
 mulax.w acc, vf00, temp94
 madday.w acc, vf00, temp94
 maddz.w atten, vf00, temp94
 ; dot normal with light direction
 mul.xyz temp96, vert_to_light, normal
 mulax.w acc, vf00, temp96
 madday.w acc, vf00, temp96
 maddz.w intensity95, vf00, temp96
 ; clamp intens >= 0.0 (don't let light be sucked away...)
 maxx.w intensity95, intensity95, vf00
 ; modulate the light diffuse color by the intensity
 mulw.xyz local_diff95, light_diff, intensity95
 ; modulate local diffuse light by material diffuse
 mula.xyz acc, local_diff95, material_diff
 add.xyz half_angle, vert_to_eye, vert_to_light
 esadd p, half_angle
 mfp.w half_angle, p
 ersqrt p, half_anglew
